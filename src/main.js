...
// setTimeout(() => {
    ...
    const mvElement = document.querySelector('#tableModel');

    mvElement.addEventListener('load', () => {
        let viewModal = new ViewModal();
        const sceneGlb = mvElement[Object.getOwnPropertySymbols(mvElement).find(e => e.description === 'scene')];
        ...
        // let screenTexture = textureLoader.load('/textures/Desk_small_screen_Emissive1.png'); 
